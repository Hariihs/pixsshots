...
export const useGetPosts = () => {
  return useInfiniteQuery({
    ...
    queryFn: ({ pageParam }) => getInfinitePosts({ pageParam: pageParam as number }), // Assuming getInfinitePosts expects a number
    ...
    initialPageParam: null as number | null, // Provide an initial value for pageParam (can be null if not applicable)
  });
};
